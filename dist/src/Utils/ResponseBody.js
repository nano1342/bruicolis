...
class ResponseBody {
    ...
    returnObject;
    error;
    constructor(status, message, returnObject, error) {
        this.status = status;
        this.message = message;
        this.returnObject = returnObject;
        this.error = error;
    }
    static getResponseBodyOk(message) {
        return new ResponseBody('success', message, undefined, undefined);
    }
    static getResponseBodyOkWithObject(message, object) {
        return new ResponseBody('success', message, object, undefined);
    }
    static getResponseBodyFail(message, error) {
        return new ResponseBody('fail', message, undefined, error);
    }
    static getResponseBodyFailDefault() {
